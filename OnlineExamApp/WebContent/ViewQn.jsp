...
List<Bean2> listqn=(List<Bean2>)session.getAttribute("listqn");

%>
<a href="SelectView.jsp">Back</a>

<table border=1 width=100%>
    <tr><td>Domain</td><td>Question</td><td>Option1</td><td>Option2</td><td>Option3</td><td>Option4</td><td>Answer</td></tr>
 <c:forEach items="${listqn}" var="e" >
    <tr><td>${e.dom}</td><td>${e.quest}</td><td>${e.o1}</td><td>${e.o2}</td><td>${e.o3}</td><td>${e.o4}</td><td>${e.ans}</td><td><a href='EditQnServ?id=${e.id}&VF=set'>Edit</a></td><td><a href='DeleteQnServ?id=${e.id}&VF=set'>Delete</a></td></tr>
 </c:forEach>
</table>
